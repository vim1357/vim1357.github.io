...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    blurb:
      'Работал над внутренним порталом для сотрудников: медиа/UGC, конструктор страниц, опросы. Запустил с командой базу знаний на платформе (0 → 1). Вместе с командой вырастил внутреннюю метрику ICX +17%.',
  },
  {
    name: 'Cloud.ru',
